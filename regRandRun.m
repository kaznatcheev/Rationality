function [data, genotypes, minds] = regRandRun(n_agents, n_epochs, ...
    pmod, degree, game, epsilon, mutation_rate, mutation_size, boundaries)
%[data, genotypes, minds] = regRandRun(n_agents, n_epochs, pmod, degree, ...
%   game, epsilon, mutation_rate, mutation_size, boundaries)
%input:
